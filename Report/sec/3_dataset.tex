...
The Histogram of Oriented Gradients (HOG) is a feature descriptor that captures the distribution of gradient orientations within localized regions of the image. 
By dividing the image into small cells and computing histograms of gradient directions, HOG provides a robust representation of the palm's shape and structure~\cite{Parulan2024-qo}. 
This technique is beneficial for palm segmentation as it emphasizes the edges and contours of the palm, making them more distinguishable from the background and the rest of the hand. 
HOG features are also less sensitive to variations in lighting and small deformations, which enhances the segmentation accuracy and reliability in real-world scenarios.

\begin{figure}[t]
  \centering
   \includegraphics[width=0.8\linewidth]{Images/preprocessing.png}
