...
The Black-Hat morphological transform is a key preprocessing step for our palm image analysis, defined as \box{BlackHat(I) = Closing(I) - I}. It isolates darker, smaller image structures—primarily palm lines—by subtracting the original image from its morphological closing. This effectively enhances thin, dark creases while suppressing uniform skin texture.
