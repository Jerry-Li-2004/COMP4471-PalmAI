...
\end{equation*}
It isolates darker, smaller image structures—primarily palm lines—by subtracting the original image from its morphological closing ~\cite{opencv_morphological}. 
...
\begin{figure}[t]
  ...
  \end{verbatim}
  \centering
  \caption{An example of labels produced by a VLM, in the format of a JSON dictionary.}
  \label{fig:onecol}
\end{figure}